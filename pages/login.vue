  ...
  <div class="bg-white shadow-md rounded-lg p-8 w-full max-w-md mx-auto mt-12">
    ...
    <form @submit.prevent="submitLogin" class="space-y-4">
      ...
      <button
        type="submit"
        :disabled="isLoading"
        class="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 disabled:cursor-not-allowed text-white font-bold py-2 px-4 rounded flex items-center justify-center space-x-2 transition-colors duration-200"
      >
        <svg
          v-if="isLoading"
